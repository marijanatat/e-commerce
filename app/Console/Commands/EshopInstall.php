...
class EshopInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'eshop:install { --force:Do not ask for user confirmation}';
     ...
     * @var string
     */
    protected $description = 'Install dummy data for e-shop';
    ...
    public function handle()
    {
        ...
        if($this->confirm('This will delete all data and install the default dummy data. Are you sure?')){
            ...
            if($copySuccess){
                $this->info('images successfully copied to the storage folder.');
            }
       
       $this->info('dummy data instaled.');
        }
    }
